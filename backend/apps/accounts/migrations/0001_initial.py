...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_picture', models.ImageField(blank=True, upload_to='profiles/pictures/')),
                ...
                ('entry_type', models.CharField(blank=True, choices=[('NDA', 'NDA'), ('CDS', 'CDS'), ('AFCAT', 'AFCAT'), ('INET', 'INET'), ('AGNIVEER', 'Agniveer')], db_index=True, max_length=20)),
                ('preferred_service', models.CharField(blank=True, choices=[('ARMY', 'Army'), ('NAVY', 'Navy'), ('AIR_FORCE', 'Air Force')], db_index=True, max_length=20)),
                ('ssb_attempts', models.PositiveSmallIntegerField(default=0)),
                ('recommended_status', models.BooleanField(default=False)),
                ('ssb_board', models.CharField(blank=True, max_length=120)),
